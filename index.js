/* ============================================================
   [VAULT] TICKET SYSTEM v3 — staff mygtukai apsaugoti +
   "Siusti prekę" su laukeliu ir nuotraukom į DM
============================================================ */
...
function registerHandlers(client) {
  /* Kai staff įkelia nuotraukas po "Siusti prekę" — persiunčiam klientui į DM */
  ...
  client.on('interactionCreate', async (i) => {
    try {
      ...
      if (i.isButton() && i.customId.startsWith('t:')) {
        /* ŽAIDĖJAI NEGALI NAUDOTI — tik staff */
        ...
        switch (i.customId) {
          ...
          case 't:send': {
            /* Laukelis informacijai → siunčiam į DM */
      ...
      /* "Siusti prekę" modal — info į DM + nuotraukų langas */
